(async () => {
  ...
  try {
    ...
    const baseline = cmp.baseline_v5_masks || {};
    const bestCv = cmp[data.best_cv] || {};
    const bestIn = cmp[data.best_in_sample] || {};
    ...
    setTxt('m_baseline_iou', baseline.miou);
    setTxt('m_baseline_ari', baseline.ari);
    setTxt('m_best_cv_iou', bestCv.miou);
    setTxt('m_best_cv_ari', bestCv.ari);
    setTxt('m_best_in_iou', bestIn.miou);
